...
#Spatial parameters: HARCODED specifically for a displacement of 100-km and 321 degrees azimuth
...
experiment_folder = '../QPEperturbations/c2020_method_disp' + str(disp_length) + 'km/'
...
qpe_folder = '../QPEperturbations/disp' + str(disp_length) + 'km/angle_321.0/'
