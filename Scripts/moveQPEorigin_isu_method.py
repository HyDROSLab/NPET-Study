...
def worker():
		...
		#Crop to make grid slightly smaller
		#sp.call("gdalwarp -co COMPRESS=Deflate -te " + inArgs[7] + " " + inArgs[8] + " " + inArgs[9] + " " + inArgs[10] + " -tr " + inArgs[5] + " " + inArgs[6] + " " + inArgs[4] + " " + inArgs[11] + "temp_" + inArgs[12] + ".tif", shell=True)
		#sp.call("mv " + inArgs[11] + "temp_" + inArgs[12] + ".tif " + inArgs[4], shell=True)
...
#Spatial parameters
origin_lat = 55.733065000000003
origin_lon = -130.905259999999998 
ulx = -130.9052600
uly = 55.7330650 
lrx = -60.9052600
lry = 20.7330650 
...
experiment_folder = '/hydros/humberva/PROFLASH/NPET/OSSE/RealQPE/EllicotCity/QPEperturbations/' + pert_type  + '/isu_method_disp' + str(disp_length) + 'km/'

#Read in new origins to create synthetic fields
#latitude,longitude,distance(km),direction angle(degrees)
perturbation_file = '/hydros/humberva/PROFLASH/NPET/OSSE/RealQPE/EllicotCity/QPEperturbations/' + pert_type  + '/isumethod_5deg_distance_enforced_' + str(disp_length) + 'km.csv'
...
#qpe_folder = '/hydros/humberva/PROFLASH/NPET/OSSE/RealQPE/EllicotCity/ef5_outputs/baseline_precip/'
qpe_folder = '/hydros/humberva/PROFLASH/NPET/OSSE/RealQPE/EllicotCity/QPEperturbations/' + pert_type  + '/disp' + str(disp_length) + 'km/angle_129.0/'
...
mail('humber@ou.edu', 'QPE generation DONE', 'Grids are ready.')
